# This FreeCAD macro script makes Cabin Back objects
...
cabin_floor_2 = Cabin_Floor(freecad_document = document, 
                          ...
                          centre =  App.Vector(side_panel_seperation_x, 0, 0))
# Make Cabin Backs
cabin_back_1 = Cabin_Back(freecad_document = document, 
                          structure_label = "Cabin_Back_1")
cabin_back_2 = Cabin_Back(freecad_document = document, 
                          structure_label = "Cabin_Back_2",
                          centre =  App.Vector(side_panel_seperation_x, 0, 0))
